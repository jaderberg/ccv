...
// To compile:
// clang canny.c -L"/Users/jaderberg/Work/Utils/ccv_max/lib" -I"/Users/jaderberg/Work/Utils/ccv_max/lib" -lccv -o canny `cat /Users/jaderberg/Work/Utils/ccv_max/lib/.LN` -lm
...
int main(int argc, char** argv)
{
	...
	ccv_canny(image, &swt, CCV_8U, size,low_thresh,high_thresh);
